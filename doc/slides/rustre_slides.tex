...
\begin{frame}{\null}
  \begin{tikzpicture}[node distance=1cm, align=center]
    ...
    \node (extraction)      [rectangle, rounded corners, draw=black, fill=blue!50, minimum height = .75cm, minimum width=3cm, below = of object]         {Extraction de code};
...
\begin{frame}{\null}
  \begin{tikzpicture}[node distance=1cm, align=center]
    \node (parsing)         [rectangle, rounded corners, draw=black, fill=blue!50, minimum height = .75cm, minimum width=3cm]                            {Parsing};
    \node (extraction)      [rectangle, rounded corners, draw=black, fill=blue!50, minimum height = .75cm, minimum width=3cm, above right = of parsing]         {Code extraction};
